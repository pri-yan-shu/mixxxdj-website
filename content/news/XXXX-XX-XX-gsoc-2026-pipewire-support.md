...
As PipeWire gains more popularity on linux, and more and more distributions having it as the default, Mixxx is lagging behind in the rich featureset provided by the API. With this project, Mixxx can now participate directly in the modern Linux audio stack without any compatibility layers or limitations.
